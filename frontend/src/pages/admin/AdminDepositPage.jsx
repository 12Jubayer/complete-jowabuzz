...
export default function AdminDepositPage() {
  ...
  const loadDeposits = useCallback(async () => {
    setLoading(true);
    try {
      const result = await fetchAdminDeposits({
        startDate,
        endDate,
  ...
  return (
    <>
      ...
      <div className="space-y-4">
        <h2 className="text-[28px] font-bold tracking-tight text-slate-900">Deposit</h2>
