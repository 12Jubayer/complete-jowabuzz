...
SELECT COUNT(*) AS total_profiles FROM affiliate_profiles;
SELECT COUNT(*) AS affiliate_applicants FROM affiliate_profiles WHERE registered_as_affiliate=1;
SELECT ap.id, u.name, u.email, ap.status, ap.registered_as_affiliate
