...
FILES = [
    ...
    'backend/controllers/siteGameController.js',
    'backend/controllers/gameController.js',
    'frontend/src/utils/categoryNavigation.js',
    'frontend/src/components/MobileMenuDrawer.jsx',
    'frontend/src/services/siteGameService.js',
    'frontend/src/services/gameService.js',
    'frontend/src/services/gameWalletService.js',
    'frontend/src/components/GameGrid.jsx',
    'frontend/src/components/PopularGames.jsx',
    'frontend/src/components/FeaturedGameCard.jsx',
...
sftp.close()
_, o, _ = c.exec_command(f'cd {REMOTE}/frontend && npm run build 2>&1 | tail -8', timeout=600000)
print(o.read().decode('utf-8', errors='replace'))
_, o, _ = c.exec_command('pm2 restart jowabuzz --update-env', timeout=30)
print(o.read().decode('utf-8', errors='replace')[:500])
time.sleep(3)
_, o, _ = c.exec_command('curl -s "http://127.0.0.1:3001/api/site/games?category=sports&limit=6" | head -c 1200', timeout=20)
print('sports games:', o.read().decode('utf-8', errors='replace'))
c.close()
print('DONE')
